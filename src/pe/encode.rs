...
pub fn encode(data: &structs::PEHeader) -> Vec<u8> {
    ...
    // optional_header
    match &data.optional_header {
        structs::optional_header::OptionalHeader::OptionalHeader32(optional_header) => {
            // magic
        ...
        structs::optional_header::OptionalHeader::OptionalHeader64(optional_header) => {
            // address_of_entry_point
            bytes.extend_from_slice(&optional_header.address_of_entry_point.to_le_bytes());
            // base_of_code
            bytes.extend_from_slice(&optional_header.base_of_code.to_le_bytes());
        ...
        structs::optional_header::OptionalHeader::None => todo!(), // 这并不是正常情况
    }
